<template>
    <v-container class="CRUD-P" fluid fill-height>
        <v-row class="Op-Editartext-center mt-5 d-flex">
            <v-col style="border:5px solid red" class="OP-TABLAS" cols="6">
            ...
            <v-col style="border:5px solid red" cols="6" class="OP-TABLAS text-right">
        ...
        <v-row>
            <v-col style="border:5px solid red;margin:auto" cols="5" class="OP-TABLAS mt-10 pt-0">
