<template>
    ...
    <v-row class="OP text-center mt-5" cols="12">
        ...
        <v-col  cols="2" style="border:5px solid yellow"  class="text-center">
    ...
    <v-row class="d-flex justify-center p-0" >
        ...
        <v-col :cols="!adminVerification ? '8' :''">
            ...
            loading-text="Cargando...Porfavor espere" :items="users" sort-by="descripcion" class="Tabla text-center">
    ...
    data() {
        return {
            ...
            columnas:[//EDITAR INFORMACION
                ...
                {text:'SOCIO' ,value:'SOCIO', class:'Header_Tabla'},
                {text:'NOMBRE' ,value:'NOMBRE', class:'Header_Tabla'},
                {text:'APELLIDO 1' ,value:'APELLIDO_1', class:'Header_Tabla'},
                ...
                { text: 'ACCIONES', value: 'actions', class:'Header_Tabla', sortable: false ,width: '300px' },
            ] ,
