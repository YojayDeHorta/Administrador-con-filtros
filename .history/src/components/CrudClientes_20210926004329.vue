<template>
    <v-container class="CRUD-P" fluid fill-height>
        <v-row class="Op-Editartext-center mt-5 d-flex">
            <div class=" ">
                <v-col class="Op-Iconos text-center" style="width: 1500px;border:5px solid red">
                    <v-btn v-if="adminVerification" color="primary" @click="dialog = true; formTitle = 'Agregar usuario';
                  resetUser();
                ">
                ...
                <v-col class="Op mt-0 pt-0" style="border:5px solid yellow width: 50%;">
