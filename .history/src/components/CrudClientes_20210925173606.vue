    ...
    mounted() {
        ...
        computedHeaders () {
            if(this.adminVerification){
                ...
                let columnasMod=[
                    {text:'ID' ,value:'ID', class:'blue-grey darken-3 white--text',width:"150px"},
                    {text:'NUMERO DE SOCIO' ,value:'NUM_SOCIO', class:'blue-grey darken-3 white--text',width:"150px"},
                    {text:'SOCIO' ,value:'SOCIO', class:'socio blue-grey darken-3 white--text',filter: this.socioFilter,width:"150px"},
                    {text:'NOMBRE' ,value:'NOMBRE', class:'blue-grey darken-3 white--text',filter: this.nameFilter,width:"150px"},
