<template>
  <v-container class="CRUD-P" fluid fill-height>
    <v-row class="Op-Editar text-center mt-5 d-flex">
      <div>
        <v-col class="Op">
          <v-btn
            v-if="adminVerification"
            color="primary"
            @click="
              dialog = true;
              ...
              resetUser();
            "
            ><v-icon class="mr-2">mdi-account-plus</v-icon> añadir</v-btn
          >
        </v-col>
        ...
        <v-col class="Op text-center">
          <v-btn
            color="teal darken-1"
            @click="descargar()"
            v-if="adminVerification"
            ><v-icon color="white">mdi-file-download</v-icon></v-btn
          >
          <!--descarga normal-->
          <v-btn
            color="teal darken-1 white--text"
            v-if="!adminVerification"
            @click="descargarFiltro()"
          ...
          >
            <span v-if="file == null"
              ><v-icon class="mr-1">mdi-upload</v-icon>subir archivo</span
            >
            <span v-else
          ...
          >
            ...
            >
              <v-btn color="green  white--text" @click="prepareEdit(item)"
                ><v-icon small class="mr-2"> mdi-pencil </v-icon> editar</v-btn
              >
              <v-btn
                color="red white--text"
                class="ml-1"
                @click="deleteUser(item.ID)"
                ><v-icon small> mdi-delete </v-icon> eliminar</v-btn
              >
            </template>
          </v-data-table>
        </v-card>
