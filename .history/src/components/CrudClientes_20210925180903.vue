<template>
    ...
    <v-row class="d-flex justify-center p-0" >
        ...
        <v-col :cols="!adminVerification ? '8' :''">
            ...
            loading-text="Cargando...Porfavor espere" :items="users" sort-by="descripcion" class="text-center">
        ...
        computedHeaders () {
            if(this.adminVerification){
                ...
                let columnasMod=[
                    ...
                    {text:'NUMERO DE SOCIO' ,value:'NUM_SOCIO', class:'Header_Tabla p-0'},
                    {text:'SOCIO' ,value:'SOCIO', class:'Header_Tabla',filter: this.socioFilter},
                    {text:'NOMBRE' ,value:'NOMBRE', class:'Header_Tabla',filter: this.nameFilter},
