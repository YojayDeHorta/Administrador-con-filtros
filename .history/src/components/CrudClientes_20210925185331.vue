<template>
    ...
    <v-row class="d-flex justify-center p-0" >
        ...
        <v-col :cols="!adminVerification ? '8' :''">
            ...
            <v-data-table border="1" style="border:5px solid yellow; border-collapse: collapse;" :headers="computedHeaders" :loading="loading" :search="search" @current-items="getFiltered"
