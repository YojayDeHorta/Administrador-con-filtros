<template>
    ...
    <v-row class="d-flex justify-center p-0" >
        ...
        <v-col :cols="!adminVerification ? '8' :''">
            ...
            loading-text="Cargando...Porfavor espere" :items="users" sort-by="descripcion"    :bordered="bordered" class="Tabla-Cliente elevation-1 theme--light table-bordered">
        ...
        computedHeaders () {
            if(this.adminVerification){
                ...
                let columnasMod=[
                    ...
                    {text:'DIRECCION' ,value:'DIRECCION', class:'Header_Tabla'},
