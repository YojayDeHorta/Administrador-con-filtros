<template>
    ...
    <v-row class="Op-Editar text-center mt-5" cols="12">
        <v-col class="Op"  cols="2">
        ...
        <v-col   cols="5" class="Op mt-0 pt-0">
        ...
        <v-col  cols="2" style="border:5px solid yellow"  class="Op text-center">
