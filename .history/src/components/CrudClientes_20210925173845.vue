<template>
    ...
    <v-row class="d-flex justify-center p-0" >
        ...
        <v-col :cols="!adminVerification ? '8' :''">
            <v-card width="100%">
            <!-- esto es la tabla -->
            <v-data-table :headers="computedHeaders" :loading="loading" :search="search" @current-items="getFiltered"
            :footer-props="{'items-per-page-text':'usuarios por pagina','items-per-page-options':[10, 50, 100, 200, -1]}"  :options="options"
            loading-text="Cargando...Porfavor espere" :items="users" sort-by="descripcion" class="Tabla-Cliente elevation-1 theme--light table-bordered">
        ...
        <v-form  @submit.prevent="addAndEditUser" >
            ...
            <v-container>
                ...
                <v-row>
                    <v-col cols="4" >
                        <div>Parentesco:</div>
                        <v-select :items="Parentesco" v-model="user.PARENTESCO" label="Parentesco" solo></v-select>
                    </v-col>
                    <v-col cols="4" >
    ...
    mounted() {
        ...
        computedHeaders () {
            if(this.adminVerification){
                ...
                let columnasMod=[
                    {text:'ID' ,value:'ID', class:'Header_Tabla',width:"150px"},
                    {text:'NUMERO DE SOCIO' ,value:'NUM_SOCIO', class:'Header_Tabla blue-grey darken-3 white--text',width:"150px"},
                    {text:'SOCIO' ,value:'SOCIO', class:'Header_Tabla',filter: this.socioFilter,width:"150px"},
                    {text:'NOMBRE' ,value:'NOMBRE', class:'Header_Tabla blue-grey darken-3 white--text',filter: this.nameFilter,width:"150px"},
                    {text:'APELLIDO 1' ,value:'APELLIDO_1', class:'Header_Tabla blue-grey darken-3 white--text',filter: this.apellidoFilter},
                    {text:'APELLIDO 2' ,value:'APELLIDO_2', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'PARENTESCO' ,value:'PARENTESCO', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'DNI' ,value:'DNI', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'PD' ,value:'PD', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'DIRECCION' ,value:'DIRECCION', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'CODIGO POSTAL' ,value:'COD_POSTAL', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'LOCALIDAD' ,value:'LOCALIDAD', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'PROVINCIA' ,value:'PROVINCIA', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'PAIS' ,value:'PAIS', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'MOVIL' ,value:'MOVIL', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'FIJO' ,value:'FIJO', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'EMAIL' ,value:'EMAIL', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'EDAD' ,value:'EDAD', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'SOLA' ,value:'SOLA', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'MAYOR' ,value:'MAYOR', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'TEFILÁ' ,value:'TEFILA', class:'Header_Tabla blue-grey darken-3 white--text'},
                    {text:'OBSERVACIONES' ,value:'OBSERVACIONES', class:'Header_Tabla blue-grey darken-3 white--text'},
                ] 
                return columnasMod
            }
        },
