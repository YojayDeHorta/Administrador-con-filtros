<template>
    <v-container class="CRUD-P" fluid fill-height>
        <v-row class="Op-Editartext-center mt-5 d-flex">
            <v-col style="border:5px solid red"  class="OP-TABLAS" cols="2">
            ...
            <v-col style="border:5px solid red"   cols="5" class="OP-TABLAS mt-0 pt-0">
            ...
            <v-col style="border:5px solid red"   cols="2"  class="OP-TABLAS text-right">
