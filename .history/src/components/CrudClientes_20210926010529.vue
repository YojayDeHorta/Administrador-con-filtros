            ...
            <div class=" ">
                <v-col class="Op-Iconos">
                    <section class="section_1">
                        <v-btn class="Btn-Icon" v-if="adminVerification" color="primary" @click="dialog = true; formTitle = 'Agregar usuario';
                        resetUser();">
                    ...
                    <section class="section_4">
                        <v-btn color="primary" class="Btn-Icon ml-1" outlined v-if="adminVerification" @click="chooseFiles()">
                            <span v-if="file == null">
...
<style>
    ...
    .section_1,.section_2,.section_3,.section_3{
